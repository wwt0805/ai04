...
def cond(true_value, false_value, cond):  # cond
...
class Cond(Exp):
    ...
    def simplify(self):
        ...
        if isinstance(c, Const):
            return self.true_value.simplify() if c.value else self.false_value.simplify()
        return self
    ...
    def deriv(self, x):
        return Cond(self.true_value.deriv(x), self.false_value.deriv(x), self.conditon)
...
class Sin(Exp):
    ...
    def simplify(self):
        return math.sin(self.value.value) if isinstance(self.value, Const) else self
...
class Cos(Unary):
    ...
    def simplify(self):
        return math.cos(self.value.value) if isinstance(self.value, Const) else self
